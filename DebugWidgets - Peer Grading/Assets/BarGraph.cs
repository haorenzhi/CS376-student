...
public class BarGraph : MonoBehaviour
{
    ...
    public void SetReading(float value)
    {
        ...
        // Otherwise, use green for positive values and blue for negative
        var color = (value < 0) ? Color.blue : Color.green;
        ...
        Text.text = this.name + " : " + value.ToString();
    ...
    public void SetWidthPercent(float value, Color c)
    {
        ...
        BarTransform.localScale = new Vector3(value, 1, 1);
        if(signedDisplay) {
            BarTransform.localScale = new Vector3(value/2, 1, 1);
        }
